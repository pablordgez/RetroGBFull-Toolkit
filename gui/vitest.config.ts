  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/main/projectLauncherPrimitives.ts',
      ...
      exclude: [
        ...
        'src/renderer/src/components/ProjectWorkspace/useSceneWorkspacePickers.ts',
        'src/renderer/src/components/ProjectWorkspace/useSceneWorkspaceScriptData.ts',
        ...
        'src/renderer/src/components/Docking/ResourceManagementState.ts',
        'src/renderer/src/components/Docking/projectResourceEvents.ts',
        'src/renderer/src/components/ScriptEditor/clangd/clangdMessages.ts',
